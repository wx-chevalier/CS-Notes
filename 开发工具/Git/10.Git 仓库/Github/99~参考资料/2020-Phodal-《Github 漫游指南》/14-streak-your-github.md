...
![Longest Streak](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/longest-streak.png)
...
![365 Streak](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/365-streak.jpg)

同时这似乎也意味着，我每天的 commit 数与之相比多了很多。

在连击 20 的时候，有这样的问题：_为了 commit 而 commit 代码_，最后就放弃了。
...
![Repo Status](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/repo-status.png)
...
![Problem](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/problem.jpg)
...
![GitHub 200 days](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/github-200-days.png)
...
![Google Maps solr](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/solr.png)
...
![Skill Tree](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/skilltree.jpg)
...
![Sherlock skill tree](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/sherlock.png)

代码：[https://github.com/phodal/sherlock](https://github.com/phodal/sherlock)

#### Django Ionic ElasticSearch 地图搜索

![Django Elastic Search](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/elasticsearch_ionit_map.jpg)
...
![Resume](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/resume.png)
...
![Nginx Pig](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/nginx_pig.jpg)
...
![GitHub 365](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/github-365.jpg)
...
![lan](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/lan.png)

![EchoesWorks](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/echoesworks.png)
...
![Lan IoT](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/lan-iot.jpg)
...
![Gtihub 500](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/github-500.jpg)
...
![情绪周期](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/qingxu.jpg)
...
![打字练习](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/huovd.png)
...
![10000 hours](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/10000.png)
...
1. 尝试使用 React + Redux + Koa 2、或者 Angular 2 + TypeScript，这样我们就能凭此来学习新的技术。
2. 尝试使用 CQRS 架构来设计 CMS，这样我们就可以练习在架构方面的能力。

在我们想到一点我们可以练习的技术的时候，这就是一个可以变成 Issue 管理的内容，我们就可以针对性的提高。

通常在这种情况下，我们知道自己不知道什么东西，当我们处于不知道自己不知道、不知道自己知道时，那我们就需要网上的各种技能图谱——如 StuQ 的技能图谱。

![skilmap](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/skillmap.png)

然后了解图谱上的一个个的内容，尽可能依照此构建自己的体系——以让自己走向知道自己不知道的地步，然后我们才依此来展开练习。

建议试试我们家的 Growth 哈，地址：http://growth.ren。
...
![2014.png](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/2014.png)
...
![2015.png](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/2015.png)

整个区间就是刷各种前端的技术栈，创建了各种有意思的项目：

- [Lettuce 框架](https://github.com/phodal/lettuce)，一个基于简单的 SPA 框架
...
![2016.png](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/phodal-github/2016.png)
